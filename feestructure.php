...
<body>
    ...
    <div class="container">
        <h2 class="headings"> FEE STRUCTURE 2017-2018</h2>
        <div class="row row-content justify-content-center">
            <div class="col-12 col-sm-9">
                ...
                <thead class="thead-inverse">
                    <tr>
                       <th>Nature of Fees</th>
                       <th>Fee Structure</th> 
                    </tr>
                </thead>
                <tbody>
                  <tr>
                      <td>Addmission Fee<br /> (once at the time of new addmission)</td>
                      <td>200</td>
                  </tr>
                  <tr>
        ...
        <div class="row row-content justify-content-center">
            <div class="col-12 col-sm-9">
                ...
                <thead class="thead-inverse">
                    <tr>
                           <th>Monthly Fees</th>
                           <th>Tuition fee<br />(per month)</th> 
                           <th>Development Fee<br />(per month)</th> 
                    </tr>
                </thead>
                <tbody>
                    <tr>
