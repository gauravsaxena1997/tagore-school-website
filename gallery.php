           ...
           <a class="navbar-brand" href="#"><img src="images/logo.png" class="img-fluid"></a>
              <div class="collapse navbar-collapse" id="Navbar">        
                <ul class="navbar-nav" style="padding-left: 10px;">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="#"><span class="fa fa-picture-o fa-lg"></span> Gallery</a></li>
    ...
    <div class="tz-gallery">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="images/edmunds_annual_function.jpg">
                    <img src="images/edmunds_annual_function.jpg" alt="" height="192" width="44%">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="images/2.jpg.jpg">
                    <img src="images/2.jpg.jpg" alt="" height="192" width="44%">
                </a>
            </div>
            <div class="col-sm-12 col-md-4">
                <a class="lightbox" href="images/HEMA-school-annual-function.jpg">
                    <img src="images/HEMA-school-annual-function.jpg" alt="" height="192" width="44%">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="images/seedling-annual-function-1.jpg">
                    <img src="images/seedling-annual-function-1.jpg" alt="" height="192" width="44%">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="images/DSC_3404.jpg">
                    <img src="images/DSC_3404.jpg" alt="" height="192" width="44%">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="images/19_835144578_IMG9933.jpg">
                    <img src="images/19_835144578_IMG9933.jpg" alt="" height="192" width="44%">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="images/12.jpg">
                    <img src="images/12.jpg" alt="" height="192" width="44%">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="images/1.jpg">
                    <img src="images/1.jpg" alt="" height="192" width="44%">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="images/PHS_4519.jpg">
                    <img src="images/PHS_4519.jpg" alt="" height="192" width="44%">
                </a>
            </div>
        </div>
