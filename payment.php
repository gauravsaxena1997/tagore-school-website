        ...
        <div class="content">
            ...
            <script src="js/easyResponsiveTabs.js" type="text/javascript"></script>
                    <script type="text/javascript">
                        ...
                        <div style="padding: 8px 10px;background-color: blue;width: 15%;margin: 10px;border-radius: 5px">
                            <a href="registration.php" style="color: white">Cancel Payment</a>
                        </div>

        </div>
        <p class="footer" style="color: #B4F2FF">Copyright © 2016 Payment Form Widget. All Rights Reserved | Template by <a href="https://w3layouts.com/" target="_blank" style="color: #B4F2FF">w3layouts</a></p>
    </div>
</body>
</html>