...
<body>
    ...
    <div class="container">
        ...
        <div class="row row-content">
           <div class="col-12">
              <h3 class="headings">Location Information</h3>
           </div>
            <div class="col-12 col-sm-4 offset-sm-1"  style="margin-top: 3%">
                   <h5>Our Address</h5>
                    <address class="address" style="font-size: 120%">
                      ...
                      <a href="mailto:info@spsjaipur.com" style="color: blue">info@spsjaipur.com</a>
                    </address>
            </div>
            <div class="col-12 col-sm-6 offset-sm-1" style="margin-top: 3%">
                <h5>Map of our Location</h5>
                <div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3556.97809870585!2d75.79786121485327!3d26.935908783117632!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db3dca4bf840d%3A0xf19e655b840a171e!2sTagore+Public+School+Shastri+Nagar!5e0!3m2!1sen!2sin!4v1513146336713" frameborder="0" style="border:0" float="left"></iframe>
                </div>
            </div>
            <div class="col-12 col-sm-11 offset-sm-1" style="margin-top: 3%">
                <div class="btn-group" role="group">
                    <a class="btn btn-success" role="button" href="tel:"+91-9549992949"><i class="fa fa-phone"></i> Call</a>
                    <a class="btn btn-info" role="button" href=""><i class="fa fa-skype"></i> Skype</a>
                    <a class="btn btn-primary   " role="button" href="mailto:gurvsxen143@gmail.com"><i class="fa fa-envelope-o"></i> Email</a>
                </div>
            </div>
        </div>
        ...
        <div class="row row-content">
           <div class="col-12">
              <h3 class="headings">Send us your Feedback</h3>
           </div>
            <div class="col-12 col-md-9">
                <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea type="feedback" class="form-control" id="feedback" name="feedback" rows="10">
                            </textarea>
                        </div>
                    </div>
